...
export default function Header() {
  return (
    <div className="text-center">
      <div
        className={`${headerMarginSE} ${headerMarginIE} ${headerMarginXS} ${headerMarginSS} ${headerMarginSM} ${headerMarginMD}`}
      >
        <h1
          className={`${headerMD} ${headerSM} ${headerSS} ${headerXS} ${headerIE} ${headerSE} font-bold`}
        >
          SCOUT SEARCH
        </h1>
      </div>
      <div
        className={`${headerSecondMD} ${headerSecondSM} ${headerSecondSS} ${headerSecondXS} ${headerSecondIE} ${headerSecondSE} text-gray-30`}
      >
