...
export default function Description() {
  return (
    <div
      className={`${discriptionOptMD} ${discriptionOptSM} ${discriptionOptSS} ${discriptionOptXS} ${discriptionOptIE} ${discriptionOptSE} mx-auto`}
    >
      <div
        className={`${discriptionMD} ${discriptionSM} ${discriptionSS} ${discriptionXS} ${discriptionIE} ${discriptionSE} text-justify`}
      >
